<template>
  <b-form-group :id="_id + '-group'" :label="label_comp" :label-for="_id">
    <b-input-group>
      ...
      <template v-slot:prepend :value="null"> <slot name="prepend"></slot> </template>
